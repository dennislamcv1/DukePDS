...
def get_only_peaks(data, w):
    # replace this with your code
    return [data[i] for i in range(len(data)) if is_peak_at(data, i, w)]


def moving_average_of_peaks(data, n, w):
    # replace this with your code
    return find_moving_average(get_only_peaks(data, w), n)
...
if __name__ == "__main__":
    ...
    check_ma(
        data2, 5, [110, 113, 114, 116, 118, 118, 120, 122, 124, 126, 130, 132, 134]
    )
